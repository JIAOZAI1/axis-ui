...
- 📦 **49 个核心组件** — 覆盖通用、表单(含 Form 校验)、布局、数据展示、反馈五大类
...
| 布局 | Splitter 可拖动分栏(含 Panel) | [docs/components/splitter.md](./docs/components/splitter.md) |
...
| 表单 | Textarea 多行文本框 | [docs/components/textarea.md](./docs/components/textarea.md) |
...
| 展示 | Collapse 折叠面板(含 Item) | [docs/components/collapse.md](./docs/components/collapse.md) |
...
| 导航 | Dropdown 下拉菜单(含 Menu / Item / Divider) | [docs/components/dropdown.md](./docs/components/dropdown.md) |
